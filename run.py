...
def setupinteractive(config, config_location="config.ini"):
    ...
    config["DEFAULT"]["comment_list"] = json.dumps(
        [
            ...
            ["katilmak icin takip edin!","hazirmisiniz?","katilmak icin haziran 2019'u bekle!"],
        ]
    )

    config["DEFAULT"]["tag_list"] = json.dumps(
        ["metin2","metin2sura","metin2pvp","metin2server","metin2pvpserver","metin2pvpservertanitim"]
    )
